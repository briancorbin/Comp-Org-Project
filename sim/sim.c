...
{
    ctx->regs[$LO] = ctx->regs[inst->rtype.rs] / ctx->regs[inst->rtype.rt];
    ctx->regs[$HI] = ctx->regs[inst->rtype.rs] % ctx->regs[inst->rtype.rt];
}
